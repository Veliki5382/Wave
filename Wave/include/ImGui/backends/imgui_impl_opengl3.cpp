...
bool    ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
    ...
    if (major == 0 && minor == 0)
    {
        ...
        int __WAVE_NO_WARNING_SOLUTION_status = sscanf(gl_version, "%d.%d", &major, &minor);
    }
...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    int __WAVE_NO_WARNING_SOLUTION_status = sscanf(bd->GlslVersionString, "#version %d", &glsl_version);
